...
Java_com_example_hellojnicallback_MainActivity_writeByteToCamera
...
JNIEXPORT jboolean  JNICALL
Java_com_example_hellojnicallback_MainActivity_writeFileToCamera__Ljava_lang_String_2
    ...
    setup.frame_height = 720;
    setup.frame_bytes = 40;
    setup.file_name = param;
    int fd = open_video(setup);
    copy_frames(setup, fd);
    return true;
}
